...
{
    public class MobileGeoLocationController : ApiController
    {
        ...
        public HttpResponseMessage Set(List<GeoLocation> geo)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (GeoLocation temp in geo)
                {
                    temp.fkUserId = userId;
                    db.GeoLocations.Add(temp);
                }
